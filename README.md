...
### Introduction to Descriptive Spatial Statistics and Visualization
Workshop presentation, 2026 SICSS — Chicago State University, Chicago, Illinois
...
* Generating [choropleth maps](https://en.wikipedia.org/wiki/Choropleth_map) of crime rates
...
After installing GDAL, run the `fname` installation script, which should install the necessary versions of the R libraries needed.
